...
<template>
  <UContainer>
    <UPage>
      <UPageHeader
        title="Creators"
        description="You can add or remove creators from this collection. The people and/or organizations listed here are also shown on the public catalog page."
      >
        <template #links>
          <UButton
            color="primary"
                  ...
                  <UFormField label="Identifier Type" name="identifierType">
                    <div class="flex items-center gap-2">
                      <USelect
                        ...
                        :items="
                          generateIdentifierTypeOptions(
                            selectedCreator.nameType,
                          )
                        "
